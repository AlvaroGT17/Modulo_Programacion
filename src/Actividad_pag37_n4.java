...
public class Actividad_pag37_n4 {
	public static void main(String[] args) {
		...
		double halfBulleting;

		// variables para las notas int mediaBoletin;
		// la media es de tipo entero double mediaExpediente;
		// la media usa decimales Scanner sc = new Scanner(System.in);
		// leemos las notas
		...
		try {
			...
			System.out.println("Expediente académico: " + halfProceedings);
